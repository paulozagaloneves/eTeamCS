...
<div id="container">
    <div id="intro">
        <div id="pageHeader">
            <h1><span>Welcome to Equinox - Session Decorator</span></h1>
    ...
    <div id="linkList">
        <div id="linkList2">
            <div id="lresources">
                ...
                <ul>
                    <li><a href="http://demo.raibledesigns.com/equinox">Equinox</a></li>					
                    <li><a href="http://www.springframework.org">Spring Framework</a></li>
                    <li><a href="http://sourcebeat.com/TitleAction.do?id=7">Spring Live ~ Book</a></li>
