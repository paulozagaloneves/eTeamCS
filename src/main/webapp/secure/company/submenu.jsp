<div id="subMenu"> 
	...
	<tr> 	
		...
		<!--td><a href="javascript:alert('Members');" onmouseout="MM_swapImgRestore();"  onmouseover="MM_swapImage('members','','${ctx}/images/contacts/users.png',1);"><img src="${ctx}/images/contacts/users_gray.png" id="members" class="icon" title="Members"/> <br/>Usuários</a>&nbsp;</td-->    	
